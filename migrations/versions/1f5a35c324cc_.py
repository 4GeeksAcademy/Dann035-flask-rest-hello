...
Revision ID: 1f5a35c324cc
Revises: a5cffa318ac2
Create Date: 2025-04-07 18:01:07.532249
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('mediatype_enum', sa.Enum('VIDEO', 'IMAGE', name='mediatype'), nullable=False),
